...
//
// class ExternalBatteryAssembly extends StatefulWidget {
//   const ExternalBatteryAssembly({super.key});
//
//   @override
//   State<ExternalBatteryAssembly> createState() => _ExternalBatteryAssemblyState();
// }
//
// class _ExternalBatteryAssemblyState extends State<ExternalBatteryAssembly> {
//   @override
...
//         title: const Text('External Battery Assembly'),
//       ),
//       body: Column(
//         children: [
//           Padding(
...
class ExternalBatteryAssembly extends StatefulWidget {
  ...
  const ExternalBatteryAssembly({super.key, required this.tableValues});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('External Battery Assembly', style: TextStyle(color: Colors.black),),
      ),
      body: Column(
        children: [
          Padding(
          ...
          Padding(
            ...
            child: ElevatedButton(
                onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => HvIrFtTesting(tableValues: widget.tableValues)));
                },
