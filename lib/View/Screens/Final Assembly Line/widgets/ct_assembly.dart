...
//
// class CtAssembly extends StatefulWidget {
//   const CtAssembly({super.key, required Map<String, String> tableValues});
//
//   @override
//   State<CtAssembly> createState() => _CtAssemblyState();
// }
//
// class _CtAssemblyState extends State<CtAssembly> {
//   @override
...
class CtAssembly extends StatefulWidget {
  ...
  const CtAssembly({super.key, required this.tableValues});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('CT Assembly', style: TextStyle(color: Colors.black),),
      ),
      body: Column(
        children: [
          Padding(
          ...
          Padding(
            ...
            child: ElevatedButton(
                onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => ShuntAssembly(tableValues: widget.tableValues)));
                },
